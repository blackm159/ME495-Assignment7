...
class NEURON: 
    ...
    def Allow_Presynaptic_Neuron_To_Influence_Me(self, weight, value):
        ...
        synapseWeight = weight*value
        self.Add_To_Value(synapseWeight)
